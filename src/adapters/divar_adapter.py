...
# divar_adapter.py
# Version: 1.0.0
# Last Change: Full DivarAdapter with mock mode (2026-09-14)
...
logger = logging.getLogger("asha.adapters.divar")


class DivarAdapter(BaseAdapter):
    """Adapter دیوار — عمدتاً برای پیام‌های مربوط به آگهی‌ها."""

    def __init__(self, api_key: Optional[str] = None) -> None:
        super().__init__(platform_name="divar", api_key=api_key)
