...
# telegram_bridge.py
# Version: 1.0.0
# Last Change: Telegram Bridge (mock + interface) (2026-09-14)
...
لایه واسط برای تلگرام (از طریق Bot API یا لایه خارجی).
...
class TelegramBridge(BaseAdapter):
    def __init__(self, api_key: Optional[str] = None) -> None:
        super().__init__(platform_name="telegram", api_key=api_key)
