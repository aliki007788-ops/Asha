...
# rubika_adapter.py
# Version: 1.0.0
# Last Change: Full RubikaAdapter with mock mode (2026-09-14)
...
logger = logging.getLogger("asha.adapters.rubika")


class RubikaAdapter(BaseAdapter):
    def __init__(self, api_key: Optional[str] = None) -> None:
        super().__init__(platform_name="rubika", api_key=api_key)
